  ...
  {if $customer.is_logged && !$customer.is_guest}
    ...
    <p class="identity">
      ...
      {l s='Connected as [1]%firstname% %lastname%[/1].'
        ...
        sprintf=[
          '[1]' => "<a class='dlcLink' href='{$urls.pages.identity}'><u>",
          '[/1]' => "</u></a>",
    ...
    <p>
      ...
      {l
        ...
        d='Shop.Theme.Customeraccount'
        sprintf=[
        '[1]' => "<a class='dlcLink' href='{$urls.actions.logout}'><u>",
        '[/1]' => "</u></a>"
        ]
      }
    </p>
    ...
    <div class="clearfix">
      <form method="GET" action="{$urls.pages.order}">
        <button
                class="continue btn btn-primary btn-product-list btn-block btn-lg"
                name="controller"
                type="submit"
                value="order"
        >
