...
{block name='step_content'}
        ...
        {foreach from=$conditions_to_approve item="condition" key="condition_name"}
          <li>
              ...
              <span class="custom-checkbox">
                ...
                <div class="pedidoBannerPay">
                    <picture>
                        <img src="/img/cms/exclamación.png" alt="imagen coche logo" loading="lazy" width="30px" height="30px">
                    </picture>
                    <h3 class="pedidoBannerTextPay">Recordatorio: La compra puede estar sujeta a una autentificación de tu banco: por SMS o mediante la aplicación de tu entidad bancaria. <a class="dlcLink" href="/content/3-terminos-y-condiciones-de-uso"> Más información</a>
                    </h3>
                </div>
              </span>
          </li>
  ...
  <div id="payment-confirmation" class="js-payment-confirmation mt-4">
    <div class="ps-shown-by-js">
      <button type="submit" class="btn btn-primary btn-product-list btn-block btn-lg {if !$selected_payment_option} disabled {/if} " >
